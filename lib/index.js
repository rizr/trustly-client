    ...
    */
    ...
    self.specs = {
        deposit:{
            ...
            attributesFields: ['Locale', 'Amount', 'Currency', 'Country','MobilePhone', 'Firstname', 'Lastname','NationalIdentificationNumber', 'ShopperStatement','IP', 'SuccessURL', 'FailURL', 'TemplateURL','URLTarget', 'SuggestedMinAmount', 'SuggestedMaxAmount','IntegrationModule'],
        ...
        withdraw: {
            method: 'Withdraw',
            dataFields: ['NotificationURL', 'EndUserID', 'MessageID'],
            attributesFields: ['Locale', 'Currency', 'Country','MobilePhone','DateOfBirth', 'Firstname', 'Lastname','NationalIdentificationNumber', 'ShopperStatement','IP', 'SuccessURL', 'FailURL', 'TemplateURL','URLTarget', 'SuggestedMinAmount', 'SuggestedMaxAmount','IntegrationModule'],
            requiredFields: ['NotificationURL', 'EndUserID', 'MessageID', 'Currency']
        }
    };

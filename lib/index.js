...
var TrustlyConstructor = function (config) {
    ...
    self.specs = {
        deposit: {
            ...
            attributesFields: [
                'Locale', 'Amount', 'Currency', 'Country', 'MobilePhone', 'Firstname', 'Lastname',
                'NationalIdentificationNumber', 'ShopperStatement', 'IP', 'SuccessURL', 'FailURL', 'TemplateURL',
                'URLTarget', 'SuggestedMinAmount', 'SuggestedMaxAmount', 'IntegrationModule'
            ],
            requiredFields: ['NotificationURL', 'EndUserID', 'MessageID', 'Currency', 'Firstname', 'Lastname', 'Email']
        },
        refund: {
            method: 'Refund',
        ...
        withdraw: {
            ...
            attributesFields: [
                'Locale', 'Country', 'MobilePhone', 'DateOfBirth', 'Firstname', 'Lastname',
                'NationalIdentificationNumber', 'ShopperStatement', 'IP', 'SuccessURL', 'FailURL', 'TemplateURL',
                'URLTarget', 'SuggestedMinAmount', 'SuggestedMaxAmount', 'IntegrationModule'
            ],
            requiredFields: ['NotificationURL', 'EndUserID', 'MessageID', 'Currency','Firstname', 'Lastname', 'Email','DateOfBirth']
        }
    };
